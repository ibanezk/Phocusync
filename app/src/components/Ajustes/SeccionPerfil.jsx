...
export default function SeccionPerfil({
  ...
  if (cargandoPerfil) {
    return <p className="text-xs text-gray-500 animate-pulse uppercase tracking-wider">Sincronizando perfil...</p>;
  }
    ...
    <motion.div
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col space-y-2">
          ...
          <input
            ...
            className="bg-[#061115] border border-white/10 px-4 py-2.5 text-sm text-white focus:outline-none focus:border-[#ff4d00] transition-colors"
          />
        </div>
        <div className="flex flex-col space-y-2">
      ...
      <div className="pt-4 border-t border-white/5">
        <button
          ...
          disabled={guardando}
          className="bg-[#ff4d00] text-white text-xs tracking-widest uppercase font-semibold px-6 py-3 hover:bg-[#e04400] transition-colors disabled:opacity-50">
