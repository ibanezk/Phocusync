...
/* Componente: ModalPlanes.jsx                                               */
/* Descripción: Modal de conversión y Pricing Tier. Presenta las cuotas de   */
/*              proyectos y almacenamiento. Optimizado con scroll elástico  */
/*              en móviles y animaciones de ciclo de vida completas.        */
/* ========================================================================= */
...
export default function ModalPlanes({ isOpen, onClose }) {
  return (
    // intercepte el desmontaje del DOM y ejecute la animación 'exit' perfectamente.
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex justify-center items-start md:items-center p-4 md:p-6 bg-black/80 backdrop-blur-sm overflow-y-auto py-12 md:py-6">
          {/* Capa de fondo interactiva (Clic exterior para cerrar) */}
          ...
          <motion.div
            ...
            {/* GRID DE PLANES (Monocromo y acentuación de marca) */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch pt-2">
              ...
              {/* 2. PLAN PRO STUDIO (Acento PhocuSync Orange) */}
              {/* El escalado 'md:scale-105' resalta el plan recomendado de forma óptima en desktop */}
