...
export default function LoaderCargando({ mensaje, submensaje, isOverlay = false }) {
  const containerClasses = isOverlay
    ...
    : "min-h-screen bg-[#061115] flex items-center justify-center text-xs tracking-widest text-gray-500 uppercase";

  if (!isOverlay) {
    return <div className={containerClasses}>{mensaje}</div>;
  }
